...
const V3_PROFILES={
 ...
 shapeMatrix:{label:'Shape Matrix / Dither',tool:'stylus',crew:'byte',reveal:'matrix',narrative:['sampling luminance','building the symbol grid','mapping color into shapes','tightening the matrix','locking graphic rhythm','shape matrix live'],accent:'#f5dc72',engine:'shapeMatrix'},
 energyShield:{label:'Energy Shield / Hex',tool:'stylus',crew:'lumi',reveal:'energy',narrative:['reading the source field','igniting hex cells','materialising energy skin','driving the scan front','stabilising the glow','energy artwork live'],accent:'#53e5ff',engine:'energyShield'},
 hologram:{label:'Holographic Volume',tool:'stylus',crew:'byte',reveal:'hologram',narrative:['sampling the source','splitting depth layers','building holographic volume','adding interference','locking the projection','hologram artwork live'],accent:'#72f0ff',engine:'hologram'},
 smear:{label:'Temporal Smear / Trails',tool:'widebrush',crew:'mimo',reveal:'smear',narrative:['grabbing the image','pulling first slices','stretching temporal trails','layering visual echoes','settling the drag field','smear artwork live'],accent:'#ff8ebc',engine:'smear'},
 audioReactive:{label:'Audio Reactive Distortion',tool:'stylus',crew:'foxie',reveal:'audio',narrative:['listening to the signal','mapping frequency energy','pushing image bands','amplifying transients','locking the rhythm field','audio-reactive artwork live'],accent:'#ff5da8',engine:'audioReactive'}
};
